...
pub fn init(allocator: Allocator, font_path: []const u8, icon_font_path: []const u8, window_ptr: *Window) !UiContext {
    return UiContext{
        .allocator = allocator,
...
pub fn computeNodeSignal(self: *UiContext, node: *Node) Signal {
    var signal = Signal{
        ...
        .mouse_pos = (self.window_ptr.getMousePos() catch unreachable) - node.rect.min,
        .hovering = false,
        .held_down = false,
        .enter_pressed = false,
        .mouse_drag = null,
